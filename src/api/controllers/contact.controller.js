...
exports.get = async (req, res, next) => {
  try {
    const contact = await Contact.get(req.params.contactId, req.user._id.toString());
...
exports.update = async (req, res, next) => {
  try {
    const currentContact = await Contact.get(req.params.contactId, req.user._id.toString());
...
exports.remove = async (req, res, next) => {
  try {
    await Contact.remove(req.params.contactId, req.user._id.toString());
